...
//here the store is like a space where we are going to store the answers of the user
...
//this QuestionnaireAnswers will be used in all components that are using the questionnaire
...
//here interface QuestionnaireState means it will have currentStep, answers, isComplete, setStep, nextStep, prevStep, setAnswer, reset, complete
