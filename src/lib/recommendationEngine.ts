...
//in this module we are taking the best pc parts and laptops and making a list of them based on the user's answers.
//the response contains the best pc parts and laptops and the best pc build based on the user's answers.
//example of json object this 
...
//ths function contributes in ui by displaying insights in laptopresults page 
//this funciton is getting props from LaptopResults page 
